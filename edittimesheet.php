...
<div class="topnav" id="myTopnav">
  <a href="home.php">Personal Info</a>
  ...
  <a href="javascript:void(0);" style="font-size:15px;" class="icon" onclick="myFunction()">&#9776;</a>
	...
	<div class="container">
    <h3> Pick a date to modify the respective timesheet</h3> <br>
      <div>
        <form id="update-form" class="form-group">
          <div class="row">
          <div class="col-lg-2 col-sm-12 col-md-2 col-xl-2">
            <label for="editSheetDate">Select a date</label>
        ...
        <h3>Modify the Information:</h3>
            <form class="form-group" method = 'post' action='edittimesheet.php'>
              ...
              <div class="row">
                <div class="col-lg-4 col-sm-12 col-xl-4 col-md-4">
                  <label for="cremark1">Important Remarks</label>
              ...
              <div class="row">
                ...
                <div class="col-lg-2 col-sm-12 col-xl-2 col-md-2" style="margin-left:100px;">
                    <input type="button" class="btn btn-primary" value="Cancel" onclick="hideForm()">
              </div>
            </div>
  ...
  $ts_query = "update student_entry SET FromTime='$ts_tfrom', ToTime='$ts_tto', SubName='$ts_sub',
              StaffName='Kumi', ClassType = '$ts_ctype', Remarks = '$ts_remark', Others = 'None'
              where ADate = '$ts_realdate' and User_ID = '$userid'";
              $st = $connection->prepare($ts_query);
              $st->execute();
         ...
         var string = "<table class='table table-striped' id='mytable'>"+
             "<thead>"+
               "<tr><th>Start time</th><th>End Time</th>"+
                 "<th>Subject Name</th>"+
                 "<th>Class Type</th><th>Remarks</th><th>Other Remarks</th><th>Action</th></tr></thead>"+
             "<tbody><tr><td>"+from+"</td>"+
             "<td id='to'>"+to+"</td>"+

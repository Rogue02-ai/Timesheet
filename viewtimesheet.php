...
function getStudData(){
  ...
  string = "<table class='table table-condensed'>"+
      "<thead>"+
        "<tr><th>Start Time</th><th>End Time</th><th>Date (YYYY/MM/DD)</th>"+
          "<th>Subject Name</th>"+
          "<th>Class Type</th><th>Remarks</th><th>Other Remarks</th></tr></thead>";
  $.ajax({

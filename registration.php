...
<body>
  <div class = "col-lg-3 col-xl-3 col-xs-3 col-sm-3 sides-jumbotron">
                      ...
                      <div class="form-group col-lg-6 col-xl-6 col-sm-6 col-xs-12">
                        <label class="control-label"></label>
                            <select class="form-control" id="major-dropdown" onblur="checkRole(this.value)" required name = 'sem'/>
                              ...
                              <option value="NA" id="major-dropdown-value">NONE(If Management)</option>
                            </select>
                          </div>
                      </div>
                    <div class="row">
                      ...
                      <div class="form-group col-lg-6 col-xl-6 col-sm-6 col-xs-12">
                       ...
                       <!-- <input type="text" id="major-dropdown" placeholder="Choose term ! I will feed my self" class="form-control role" required name='usertype'>-->
                            <select class="form-control" id="major-dropdown" name='usertype' required />
                              ...
                              <option value="Student" id="major-dropdown-value">Instructor</option>
                              <option value="Faculty" id="role-dropdown-value">Managment</option>
                            </select>
                          </div>
                      </div>
...
//$ts_year=$_POST['year'];
// sql query 
$ts_query="insert into new_user(User_Type, First_Name, Last_Name, User_ID, UPassword, Gender, Email, Semester) values('$ts_utype','$ts_fname','$ts_lname','$ts_uid','$ts_pass','$ts_gender','$ts_email','$ts_sem')";

if($ts_fname!="" and $ts_uid!="" and  $ts_pass!="" and $ts_email!="" or $ts_sem=="")
{
// prepare the statment - Will have the SQL connected object in the @param stmt
$stmt = $connection->prepare($ts_query);
// Execute
$result = $stmt->execute();
//echo $ts_query;
if($result)
